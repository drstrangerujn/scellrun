...
| v1.0+   | distribution polish | Streamlit web UI was on the v0.9 plan but cut — scellrun is consumed by LLM agents, not humans directly. v1.0 will be conda-forge + Docker + frozen API. Beyond v1.0: bulk RNA-seq, metabolomics composite scoring, proteomics integration. | PLAN.md v1.0 |
